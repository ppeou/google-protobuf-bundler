...
goog.define=function(a,b){goog.exportPath_(a,b);return b};goog.DEBUG=!0;goog.LOCALE="en";goog.TRUSTED_SITE=!0;goog.STRICT_MODE_COMPATIBLE=!1;goog.DISALLOW_TEST_ONLY_CODE=!goog.DEBUG;goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;
...
var jspb={BinaryConstants:{},ConstBinaryMessage:function(){},BinaryMessage:function(){}};jspb.BinaryConstants.FieldType={INVALID:-1,DOUBLE:1,FLOAT:2,INT64:3,UINT64:4,INT32:5,FIXED64:6,FIXED32:7,BOOL:8,STRING:9,GROUP:10,MESSAGE:11,BYTES:12,UINT32:13,ENUM:14,SFIXED32:15,SFIXED64:16,SINT32:17,SINT64:18,FHASH64:30,VHASH64:31};jspb.BinaryConstants.WireType={INVALID:-1,VARINT:0,FIXED64:1,DELIMITED:2,START_GROUP:3,END_GROUP:4,FIXED32:5};
...
var person_pb = createCommonjsModule(function (module, exports) {
/**
 * @fileoverview
 * @enhanceable
...
proto.foo.bar.Person = function(opt_data) {
  googleProtobuf_pb.Message.initialize(this, opt_data, 0, -1, proto.foo.bar.Person.repeatedFields_, null);
};
goog.inherits(proto.foo.bar.Person, googleProtobuf_pb.Message);
...
proto.foo.bar.Person.PhoneNumber = function(opt_data) {
  googleProtobuf_pb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.foo.bar.Person.PhoneNumber, googleProtobuf_pb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.foo.bar.AddressBook = function(opt_data) {
  googleProtobuf_pb.Message.initialize(this, opt_data, 0, -1, proto.foo.bar.AddressBook.repeatedFields_, null);
};
goog.inherits(proto.foo.bar.AddressBook, googleProtobuf_pb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
if (googleProtobuf_pb.Message.GENERATE_TO_OBJECT) {
/**
...
proto.foo.bar.Person.toObject = function(includeInstance, msg) {
  var obj = {
    name: googleProtobuf_pb.Message.getFieldWithDefault(msg, 1, ""),
    id: googleProtobuf_pb.Message.getFieldWithDefault(msg, 2, 0),
    email: googleProtobuf_pb.Message.getFieldWithDefault(msg, 3, ""),
    phonesList: googleProtobuf_pb.Message.toObjectList(msg.getPhonesList(),
...
proto.foo.bar.Person.deserializeBinary = function(bytes) {
  var reader = new googleProtobuf_pb.BinaryReader(bytes);
...
proto.foo.bar.Person.prototype.serializeBinary = function() {
  var writer = new googleProtobuf_pb.BinaryWriter();
...
proto.foo.bar.Person.PhoneNumber.toObject = function(includeInstance, msg) {
  var obj = {
    number: googleProtobuf_pb.Message.getFieldWithDefault(msg, 1, ""),
    type: googleProtobuf_pb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.foo.bar.Person.PhoneNumber.prototype.getNumber = function() {
  return /** @type {string} */ (googleProtobuf_pb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.foo.bar.Person.PhoneNumber.prototype.setNumber = function(value) {
  googleProtobuf_pb.Message.setProto3StringField(this, 1, value);
};
...
proto.foo.bar.Person.PhoneNumber.prototype.getType = function() {
  return /** @type {!proto.foo.bar.Person.PhoneType} */ (googleProtobuf_pb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.foo.bar.Person.PhoneType} value */
proto.foo.bar.Person.PhoneNumber.prototype.setType = function(value) {
  googleProtobuf_pb.Message.setProto3EnumField(this, 2, value);
};
...
proto.foo.bar.Person.prototype.getId = function() {
  return /** @type {number} */ (googleProtobuf_pb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.foo.bar.Person.prototype.setId = function(value) {
  googleProtobuf_pb.Message.setProto3IntField(this, 2, value);
};
...
proto.foo.bar.Person.prototype.getEmail = function() {
  return /** @type {string} */ (googleProtobuf_pb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.foo.bar.Person.prototype.setEmail = function(value) {
  googleProtobuf_pb.Message.setProto3StringField(this, 3, value);
};
...
proto.foo.bar.Person.prototype.getPhonesList = function() {
  return /** @type{!Array<!proto.foo.bar.Person.PhoneNumber>} */ (
    googleProtobuf_pb.Message.getRepeatedWrapperField(this, proto.foo.bar.Person.PhoneNumber, 4));
};


/** @param {!Array<!proto.foo.bar.Person.PhoneNumber>} value */
proto.foo.bar.Person.prototype.setPhonesList = function(value) {
  googleProtobuf_pb.Message.setRepeatedWrapperField(this, 4, value);
};
...
proto.foo.bar.Person.prototype.addPhones = function(opt_value, opt_index) {
  return googleProtobuf_pb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.foo.bar.Person.PhoneNumber, opt_index);
};
...
proto.foo.bar.AddressBook.toObject = function(includeInstance, msg) {
  var obj = {
    peopleList: googleProtobuf_pb.Message.toObjectList(msg.getPeopleList(),
...
proto.foo.bar.AddressBook.prototype.getPeopleList = function() {
  return /** @type{!Array<!proto.foo.bar.Person>} */ (
    googleProtobuf_pb.Message.getRepeatedWrapperField(this, proto.foo.bar.Person, 1));
};


/** @param {!Array<!proto.foo.bar.Person>} value */
proto.foo.bar.AddressBook.prototype.setPeopleList = function(value) {
  googleProtobuf_pb.Message.setRepeatedWrapperField(this, 1, value);
};
...
proto.foo.bar.AddressBook.prototype.addPeople = function(opt_value, opt_index) {
  return googleProtobuf_pb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.foo.bar.Person, opt_index);
};
...
var search_pb = createCommonjsModule(function (module, exports) {
/**
 * @fileoverview
 * @enhanceable
 * @suppress {messageConventions} JS Compiler reports an error if a variable or
...
goog.inherits(proto.SearchRequest, googleProtobuf_pb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.SearchRequest.toObject = function(includeInstance, msg) {
  var obj = {
    query: googleProtobuf_pb.Message.getFieldWithDefault(msg, 1, ""),
    pageNumber: googleProtobuf_pb.Message.getFieldWithDefault(msg, 2, 0),
    resultPerPage: googleProtobuf_pb.Message.getFieldWithDefault(msg, 3, 0)
  };
...
proto.SearchRequest.prototype.getResultPerPage = function() {
  return /** @type {number} */ (googleProtobuf_pb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.SearchRequest.prototype.setResultPerPage = function(value) {
  googleProtobuf_pb.Message.setProto3IntField(this, 3, value);
};
...
var all_pb = { google_protobuf: googleProtobuf_pb, person: person_pb, search: search_pb };
var all_pb_1 = all_pb.google_protobuf;
var all_pb_2 = all_pb.person;
var all_pb_3 = all_pb.search;

export default all_pb;
export { all_pb_1 as google_protobuf, all_pb_2 as person, all_pb_3 as search };
